"""
scrapers/hanime/progress.py
-----------------------------
Progress tree rendering for Hanime vacuum and quick-grab sessions.
...
def render_metadata_tree(
    ...
    root_tree.add(align_header("Source",   f"[info]{metadata.get('Source', 'Hanime')}[/info]"))
