"""
scrapers/oppai_stream/location.py
-----------------------------
Save-location resolver for OppaiStream.
...
def get_save_path(
    ...
    """
    Resolves the save root for a OppaiStream scrape session.
    ...
    while True:
        ...
        try:
            ...
            custom_ph_root = (custom_base / "oppai_stream") if is_vacuum else custom_base
