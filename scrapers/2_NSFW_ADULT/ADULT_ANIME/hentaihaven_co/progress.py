"""
scrapers/hentaihaven/progress.py
-----------------------------
Progress tree rendering for HentaiHaven vacuum and quick-grab sessions.
...
def render_metadata_tree(
    ...
    root_tree.add(align_header("Source",   f"[info]{metadata.get('Source', 'HentaiHaven')}[/info]"))
