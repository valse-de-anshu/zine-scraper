"""
scrapers/hentaimama/location.py
-----------------------------
Save-location resolver for Hentaimama.
...
def get_save_path(
    ...
    """
    Resolves the save root for a Hentaimama scrape session.
    ...
    while True:
        ...
        try:
            ...
            custom_ph_root = (custom_base / "hentaimama") if is_vacuum else custom_base
