"""
scrapers/hstream/location.py
-----------------------------
Save-location resolver for Hstream.
...
def get_save_path(
    ...
    """
    Resolves the save root for a Hstream scrape session.
    ...
    while True:
        ...
        try:
            ...
            custom_ph_root = (custom_base / "hstream") if is_vacuum else custom_base
