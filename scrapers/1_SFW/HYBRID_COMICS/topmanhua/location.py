"""
scrapers/topmanhua/location.py
------------------------------
Save-location resolver for Topmanhua.
...
def get_save_path(
    ...
    while True:
        if state == 0:
            draw_header()
            options = [("SFW", "SFW"), ("NSFW", "NSFW"), ("Back", "BACK")] if default_type == "SFW" else [("NSFW", "NSFW"), ("SFW", "SFW"), ("Back", "BACK")]
