"""
scrapers/anineko/engine.py
──────────────────────────
AniNeko download engine. Subclasses VideoEngine and adds:
...
class AninekoEngine(VideoEngine):
    """
    AniNeko specific extraction and fast-download engine.
    """
    def __init__(self):
        super().__init__()
