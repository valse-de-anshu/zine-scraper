"""
scrapers/ohentai/progress.py
-----------------------------
Progress tree rendering for Ohentai vacuum and quick-grab sessions.
...
def render_metadata_tree(
    ...
    root_tree.add(align_header("Source",   f"[info]{metadata.get('Source', 'Ohentai')}[/info]"))
