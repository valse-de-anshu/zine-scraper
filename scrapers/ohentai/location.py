"""
scrapers/ohentai/location.py
-----------------------------
Save-location resolver for Ohentai.
...
def get_save_path(
    ...
    """
    Resolves the save root for a Ohentai scrape session.
    ...
    while True:
        ...
        try:
            ...
            custom_ph_root = (custom_base / "ohentai") if is_vacuum else custom_base
