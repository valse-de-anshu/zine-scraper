"""
scrapers/pornhub/location.py
-----------------------------
Save-location resolver for PornHub.
...
def get_save_path(
    ...
    """
    Resolves the save root for a PornHub scrape session.
    ...
    while True:
        ...
        try:
            ...
            is_model = getattr(scraper, "get_link_type", lambda: "")() == "model"
            custom_ph_root = (custom_base / "pornhub") if is_model else custom_base
