"""
scrapers/hentaihaven/location.py
-----------------------------
Save-location resolver for HentaiHaven.
...
def get_save_path(
    ...
    """
    Resolves the save root for a HentaiHaven scrape session.
    ...
    while True:
        ...
        try:
            ...
            custom_ph_root = (custom_base / "hentaihaven") if is_vacuum else custom_base
